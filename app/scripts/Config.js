const Config = {
  ...
  prompts: {
    annotatePrompt: 'Research Paper Context: [The research paper is provided above as latex file]\n' +
      ...
      '"claims": [\n' +
      '{\n' +
      '"excerpt": "[A text fragment that supports evidence for the criterion assessment. IMPORTANT! maintain the latex source text as it is in the original. IT is really important]",\n' +
      '},\n' +
      '{\n' +
      '"excerpt": "[A text fragment that supports evidence for the criterion assessment. IMPORTANT! maintain the latex source text as it is in the original. IT is really important]",\n' +
      '},\n' +
